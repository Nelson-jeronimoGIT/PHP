    ...
    <div class="container">
        <form class="d-flex" action="crud_estudiantes.php" method="post" >
            ...
            <div class="mb-3"> 
                ...
                <div class="mb-3">
                    <label for="l bl_apellidos" class="form-label"><b>Apellidos</b></label>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="txt_telefono" id="txt_telefono" class="form-control" placeholder="Telefono 4444" required>  
                </div>
                <div class="mb-3">
                    <label for="lbl_tipo_sangre" class="form-label"><b>tipo_sangre</b></label>
                    <select class="form-select" name="drop_tipo_sangre" id="drop_tipo_sangre">
                        <option value="0">---tipo_sangre---</option>
                        <?php
                        include("datos_conexion.php");
                        $db_conexion = mysqli_connect($db_host,$db_usr,$db_pass,$db_nombre);
                        $db_conexion ->real_query("select id_tipo_sanagre as id_tipo_sangre,tipo_sangre from tipo_sangre;");
            ...
            <tab le class="table table-striped table-inverse table-responsive">
                ...
                <?php
                        include("datos_conexion.php");
                        $db_conexion = mysqli_connect($db_host,$db_usr,$db_pass,$db_nombre);
                        $db_conexion ->real_query("SELECT e.id_estudiantes  as id,e.Codigo,e.Nombres,e.Apellidos,e.Dirección,e.Telefono,p.tipo_sangre,e.fecha_nacimiento,e.id_tipo_sangre FROM estudiantes as e inner join tipo_sangre as p on e.id_tipo_samgre = p.id_tipo_sangre;
                        ");
                        $resultado = $db_conexion->use_result();
                        while($fila = $resultado->fetch_assoc()){
